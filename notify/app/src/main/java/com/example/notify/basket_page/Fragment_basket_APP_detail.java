...
public class Fragment_basket_APP_detail extends Fragment {
        ...
        public boolean handleMessage(@NonNull Message message) {
            switch (message.what){
                case 0:
                    ...
                    adapter.setNotifyArrayList(Public_database_method.get_app(getActivity(),Public_data.app_packagename));
    ...
    public static Fragment_basket_APP_detail newInstance() {
        Fragment_basket_APP_detail fragment = new Fragment_basket_APP_detail();
        return fragment;
    }
